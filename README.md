...
- 킹덤 기부 : 필수 - 3가지 재화 풀기부 (일요일기준 기여도 1,190 미만일시 다이아 충전 기부필수)

- 침공전, 유물전장 디스코드(듣기) 필수

  _개인사정인한 컨텐츠 미참여 : 운영진에게 사전통보_ (무단 미참 2회이상 제명)
...
1. 중앙라인 : 우리보다 높은 점수의 킹덤이 존재할 경우
2. 방어라인 : 우리가 제일 높은 점수일 경우

### 중앙라인 유지시

1. 공격조 : 상위점수의 킹덤거점으로 침투하여 용 탈취
2. 메인조 : 중앙 라인 유지
3. 방어조 : 메인과 라인을 유지하며 필요시 아군거점 방어
4. 지원조 : 메인과 라인을 유지하며 중앙에 생성되는 용 쟁탈
