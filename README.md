...
- 거점의 대각선 입구는 단차로 인해 진입불가 / 나가는것만 됨
  - 대각선 진입 시도 시 텔포로봇 이용
...
1. 양 옆의 적 거점의 성문 입구 확보
2. 지정된 한쪽 적 거점에서 탈취 시도

### 방어

1. 거점에 생성된 용을 거점의 구석을 옴기고 스파이크로봇을 설치

- 아군의 점수 은폐 / 용 보호 용이

2. 거점 양쪽 아군 성문 지속적 관찰 필요

### 공격

1. 우선적으로 적 성문 공략 : 후반도모
2. 대각선 입구 공략시

- 텔포를 입구 단차가 있는 곳에 설치해서 적 거점 안으로 진입 후 탈취 시도
- 성문 확보 후에는 용 탈취 이후 대각선 입구를 통해 복귀
